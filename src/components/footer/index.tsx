...
export const Footer: React.FC = () => {
    ...
    return (
        ...
        <div className='flex flex-col '> 
            ...
            <footer className="w-full flex items-center justify-center bg-slate-950 p-3 px-4 py-2">
                <div className="w-full max-w-screen-xl flex-col mx-auto px-6 flex-wrap justify-center items-center sm:justify-between">
                    ...
                    <div className="flex flex-col xs:flex-col justify-center items-center gap-3 px-2 py-3 w-full">
                        <h1 className="sm:text-2xl text-sm text-blue-500 font-extrabold text-shadow-lg text-center">
                            ...
                            <strong> - 20<span className="text-orange-500">25</span></strong>
                        </h1>

                        <div className='flex flex-col justify-center items-center'>
                            <strong className='flex justify-center items-center text-orange-500'><SlMustache />‎‎ Alan Mestezk‎ ‎<SlMustache /></strong>
                    ...
                    <nav className="mt-5 max-w-screen-xl mx-auto px-6 xs:flex-row flex-col flex w-full justify-between items-center sm:justify-between">
                        <div className="flex-shrink-0">
                            <Image
                                ...
                                width={80}
                                quality={100}
                                className="sm:w-[90px] xs:w-14 w-20 object-cover rounded-lg border-4 border-orange-500"
                            />
                        </div>

                        <div className="flex-shrink-0 ">
                            <strong className='text-orange-500'>Contact us through our channels:</strong>
                                        ...
                                        (media) => {
                                            ...
                                            return (
                                                <Link
                                                    ...
                                                    target="_blank"
                                                >
                                                    <Icon size={25} className='text-orange-500 text- hover:text-blue-500 hover:scale-90 transition-all duration-500 ease-in-out' />
                                                </Link>
                                            );
                                        }
                                    )
